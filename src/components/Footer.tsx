...
export default function Footer() {
  return (
    <footer className="bg-[#121212] text-brand-cream py-24 px-6 lg:px-16 border-t border-[#2a2a2a]">
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-16 mb-20 reveal">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {/* Newsletter Form */}
          <form className="relative max-w-sm flex items-center border-b border-[#2a2a2a] pb-3">
            <input
              type="email"
              placeholder="Your email address"
              className="bg-transparent border-none text-xs text-white placeholder-brand-grey/50 focus:outline-none w-full pr-10"
              required
            />
            <button
              type="submit"
        ...
        <div className="space-y-6">
          ...
          <div className="flex space-x-4 pt-2">
            <Link href="#" className="hover:text-brand-cream text-brand-grey transition-colors" aria-label="Instagram">
            ...
            <Link href="#" className="hover:text-brand-cream text-brand-grey transition-colors" aria-label="Facebook">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
              </svg>
            </Link>
            <Link href="#" className="hover:text-brand-cream text-brand-grey transition-colors" aria-label="YouTube">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z"/>
                <polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"/>
              </svg>
            </Link>
            <Link href="#" className="hover:text-brand-cream text-brand-grey transition-colors" aria-label="Twitter">
      ...
      {/* Bottom Bar */}
      <div className="max-w-[1440px] mx-auto pt-8 border-t border-[#2a2a2a] flex flex-col md:flex-row items-center justify-between text-[10px] text-brand-grey space-y-4 md:space-y-0">
        <div>
