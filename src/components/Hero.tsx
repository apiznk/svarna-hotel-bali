...
import { Play, Pause, Volume2, VolumeX, Calendar, Users, ChevronDown } from "lucide-react";
...
export default function Hero() {
  ...
  return (
    <section className="relative h-screen w-full bg-brand-charcoal text-brand-cream flex flex-col justify-between overflow-hidden">
      {/* Split Grid */}
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 w-full h-full">
        {/* Left Panel: Brand Spec & Typography */}
        <div className="lg:col-span-5 flex flex-col justify-start pt-36 lg:pt-48 px-8 lg:px-16 pb-12 border-r border-[#2a2a2a] relative z-20">
        ...
        <div className="lg:col-span-7 relative h-full w-full bg-black/40 border-t lg:border-t-0 border-[#2a2a2a] overflow-hidden">
          {/* Video element */}
          <video
            ref={videoRef}
            autoPlay
          ...
          <div className="absolute bottom-6 right-6 flex items-center space-x-3 z-30">
            <button
              onClick={togglePlay}
              className="p-3 bg-[#121212]/80 border border-[#2a2a2a] hover:bg-brand-charcoal text-white transition-colors focus:outline-none"
      ...
      <div
        id="booking"
        className="w-full z-20 px-8 lg:px-16 py-5 bg-[#121212] border-t border-[#2a2a2a]"
      >
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            <div className="relative flex items-center border border-[#2a2a2a] p-3 hover:border-brand-gold/40 transition-colors cursor-pointer bg-[#1c1c1c]">
              <Calendar className="w-3.5 h-3.5 text-brand-gold mr-3" />
              <span className="text-[11px] text-brand-cream/80">Select Date</span>
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            <div className="relative flex items-center border border-[#2a2a2a] p-3 hover:border-brand-gold/40 transition-colors cursor-pointer bg-[#1c1c1c]">
              ...
              <span className="text-[11px] text-brand-cream/80">2 Adults, 0 Children</span>
              <ChevronDown className="absolute right-3 w-3.5 h-3.5 text-brand-grey/50" />
            </div>
          </div>
